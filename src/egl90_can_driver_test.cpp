...
int reference_motion()
{
  ...
  ros::ServiceClient c_ref_mot =
      n_ref_mot.serviceClient<std_srvs::Trigger>("schunk_gripper_egl90_node/reference_motion");
  std_srvs::Trigger srv;
...
int move_pos(float pos)
{
  ...
  ros::ServiceClient c_move_pos =
      n_move_pos.serviceClient<schunk_gripper_egl90::MovePos>("schunk_gripper_egl90_node/move_pos");
...
int move_grip(float sp, float cu)
{
  ...
  ros::ServiceClient c_move_grip =
      n_move_grip.serviceClient<schunk_gripper_egl90::MoveGrip>("schunk_gripper_egl90_node/move_grip");
