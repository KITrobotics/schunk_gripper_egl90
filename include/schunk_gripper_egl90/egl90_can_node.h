...
#define MAX_CMD_RETRIES 5  // TO DO: add as parameter
...
private:
  ...
  bool moveToReferencePos(std_srvs::Trigger::Request& req, std_srvs::Trigger::Response& res);

  bool acknowledge(std_srvs::Trigger::Request& req, std_srvs::Trigger::Response& res);

  bool stop(std_srvs::Trigger::Request& req, std_srvs::Trigger::Response& res);

  bool cleanUp(std_srvs::Trigger::Request& req, std_srvs::Trigger::Response& res);

  bool movePos(schunk_gripper_egl90::MovePos::Request& req, schunk_gripper_egl90::MovePos::Response& res);

  bool moveGrip(schunk_gripper_egl90::MoveGrip::Request& req, schunk_gripper_egl90::MoveGrip::Response& res);
